        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <h2 className="mt-6 text-2xl font-bold text-gray-900">Félicitations, abonnement réussi!</h2>
              <p className="mt-2 text-gray-600">Nous sommes heureux de vous compter parmi nos abonnés.</p>
              <Button
                onClick={onClose}
