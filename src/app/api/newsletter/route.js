...
async function sendNewsletterEmail(email) {
 ...
 <div
  ...
  //       <a
  //         href="${unsubscribeUrl}"
  //         style="display: inline-block; padding: 16px 32px; background: linear-gradient(to right, #3b82f6, #14b8a6); color: white; font-size: 18px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); text-decoration: none; transition: all 0.3s ease-in-out;"
  //       >
  //         {" "}
  //         Se désabonner
  //       </a>
