...
async function sendNewsletterEmail(email) {
  ...
  const mailOptions = {
    ...
    <div style="background: linear-gradient(to right, #3b82f6, #14b8a6); padding: 20px; border-radius: 8px; text-align: center; margin-bottom: 20px;">
      <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Bienvenue chez Adventures!</h1>
    </div>
  ...
  <div style="padding: 20px; line-height: 1.5; color: #333333;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${unsubscribeUrl}"
        style="display: inline-block; padding: 16px 32px; background: linear-gradient(to right, #3b82f6, #14b8a6); color: white; font-size: 18px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); text-decoration: none; transition: all 0.3s ease-in-out;">        Se désabonner
      </a>
    </div>

    <p style="font-size: 16px; margin-bottom: 15px;">À bientôt,</p>
    <p style="font-size: 16px; font-weight: bold;">L'équipe de Adventures</p>
  </div>
